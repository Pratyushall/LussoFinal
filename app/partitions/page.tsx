...
type PartitionType = {
  key: "cncJaali" | "glass" | "metalGlass" | "sliding" | "smartGlass";
  label: string;
};

const PARTITION_TYPES: PartitionType[] = [
  { key: "cncJaali", label: "CNC Jaali Partition" },
  { key: "glass", label: "Glass Partition" },
  { key: "metalGlass", label: "Metal Frame +Glass partition" },
  { key: "sliding", label: "Sliding Partition" },
  { key: "smartGlass", label: "Smart Glass Partition" },
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-white/75 leading-relaxed">
            Elegant space makers for homes and studios.
          </p>
        </div>
      </div>
    </section>
...
function TypesSections() {
  const CNC_JAALI: Tile[] = [
    {
      src: "/images/cnc1.png",
      alt: "CNC jaali partition with geometric cutwork",
    },
    {
      src: "/images/cnc2.png",
      alt: "Traditional motif CNC jaali room divider",
    },
    {
      src: "/images/cnc3.png",
      alt: "Modern abstract CNC jaali in warm wood",
    },
    {
      src: "/images/cnc4.png",
      alt: "Ceiling-height CNC jaali with brass trims",
    },
    {
      src: "/images/cnc5.png",
      alt: "Backlit CNC jaali for foyer separation",
    },
    {
      src: "/images/cnc6.png",
      alt: "CNC jaali with layered depth effect",
    },
  ];
  ...
  const GLASS: Tile[] = [
    {
      src: "/images/gp1.png",
      alt: "Clear glass partition, slim black frames",
    },
    {
      src: "/images/gp2.png",
      alt: "Frosted glass partition for privacy",
    },
    {
      src: "/images/gp3.png",
      alt: "Fluted glass partition, soft diffusion",
    },
    {
      src: "/images/gp4.png",
      alt: "Ribbed glass with bronze hardware",
    },
    {
      src: "/images/gp5.png",
      alt: "Full-height glass partition, minimal tracks",
    },
    {
      src: "/images/gp6.png",
      alt: "Tinted glass partition, luxe tone",
    },
  ];

  const METAL_GLASS: Tile[] = [
    {
      src: "/images/mfgp1.png",
      alt: "Metal frame +glass grid partition",
    },
    {
      src: "/images/mfgp2.png",
      alt: "Slim steel frame with clear glazing",
    },
    {
      src: "/images/mfgp3.png",
      alt: "French-window style metal +glass divider",
    },
    {
      src: "/images/mfgp4.png",
      alt: "Powder-coated frame with fluted glass",
    },
    {
      src: "/images/mfgp5.png",
      alt: "Warm metal frame, smoked glass panels",
    },
    {
      src: "/images/mfgp6.png",
      alt: "Industrial black frame partition",
    },
  ];

  const SLIDING: Tile[] = [
    {
      src: "/images/slip1.png",
      alt: "Sliding partition on recessed track",
    },
    {
      src: "/images/slip2.png",
      alt: "Wide-span sliding divider, soft close",
    },
    {
      src: "/images/slip3.png",
      alt: "Timber frame sliding partition with glass",
    },
    {
      src: "/images/slip4.png",
      alt: "Contemporary sliding panels, matte finish",
    },
    {
      src: "/images/slip5.png",
      alt: "Sliding room divider with hidden guide",
    },
    {
      src: "/images/slip6.png",
      alt: "Textured sliding panels, subtle grain",
    },
  ];

  const SMART_GLASS: Tile[] = [
    {
      src: "/images/sgp1.png",
      alt: "Smart glass partition — clear mode",
    },
    {
      src: "/images/sgp2.png",
      alt: "Smart glass partition — opaque mode",
    },
    {
      src: "/images/sgp3.png",
      alt: "Switchable glass, meeting room partition",
    },
    {
      src: "/images/sgp4.png",
      alt: "Smart glass with slim aluminium frame",
    },
    {
      src: "/images/sgp5.png",
      alt: "Floor-to-ceiling smart glass divider",
    },
    {
      src: "/images/sgp6.png",
      alt: "Smart glass, partial opacity zones",
    },
  ];
  ...
  return (
    <>
      <TypeBlock
        id="type-cncJaali"
        title="CNC Jaali Partition"
        images={CNC_JAALI}
      />
      <TypeBlock id="type-glass" title="Glass Partition" images={GLASS} />
      <TypeBlock
        id="type-metalGlass"
        title="Metal Frame +Glass partition"
        images={METAL_GLASS}
      />
      <TypeBlock id="type-sliding" title="Sliding Partition" images={SLIDING} />
      <TypeBlock
        id="type-smartGlass"
        title="Smart Glass Partition"
        images={SMART_GLASS}
      />
    </>
  );
